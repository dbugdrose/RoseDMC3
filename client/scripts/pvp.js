const pvpResultParent = document.getElementById("pvpResultParent");
...
function resetGame(){
    pvpResultParent.innerHTML = "";
    counter = 0;
    pvpUser1Input.disabled = false;
    pvpUser2Input.disabled = false;
    pvpEnter1Btn.disabled = false;
    pvpEnter2Btn.disabled = false;
